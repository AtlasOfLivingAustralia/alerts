  ...
  private def preloadQueries() {
    ...
    if(Query.findAllByName('New images').isEmpty()){
      Query newRecordsWithImages = (new Query([
              ...
              queryPathForUI: '/occurrences/search?q=first_loaded_date:[___DATEPARAM___%20TO%20*]&sort=first_loaded_date&dir=desc&fq=multimedia:Multimedia',
              dateFormat: """yyyy-MM-dd'T'HH:mm:ss'Z'""",
              emailTemplate: '/email/biocache',
    ...
    if(Query.findAllByName('Citizen science records with images').isEmpty()){
      Query newCitizenScienceRecordsWithImages = (new Query([
              ...
              queryPathForUI: '/occurrences/search?q=first_loaded_date:[___DATEPARAM___%20TO%20*]&fq=data_resource_uid:dr364&sort=first_loaded_date&dir=desc&fq=multimedia:Multimedia',
              dateFormat: """yyyy-MM-dd'T'HH:mm:ss'Z'""",
              emailTemplate: '/email/biocache',
              recordJsonPath: '\$.occurrences',
              idJsonPath: 'uuid'
