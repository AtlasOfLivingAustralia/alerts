...
class QueryService {
  ...
  Query createTaxonQuery(String taxonGuid, String taxonName){
    new Query([
      ...
      queryPath: '/ws/occurrences/taxon/'+ taxonGuid + '?fq=last_load_date:[___DATEPARAM___%20TO%20*]&sort=last_load_date&dir=desc&pageSize=5&facets=basis_of_record',
  ...
  Query createTaxonRegionQuery(String taxonGuid, String taxonName, String layerId, String regionName){
    new Query([
      ...
      queryPath: '/ws/occurrences/taxon/'+ taxonGuid +'?' + layerId + ':%22'+regionName.encodeAsURL()+'%22&fq=last_load_date:[___DATEPARAM___%20TO%20*]&sort=last_load_date&dir=desc&pageSize=5&facets=basis_of_record',
  ...
  Query createSpeciesGroupRegionQuery(String speciesGroup, String layerId, String regionName){
    new Query([
      ...
      queryPath: '/ws/occurrences/search?q='+layerId+':%22'+regionName.encodeAsURL()+'%22&fq=species_group:'+speciesGroup+'&fq=last_load_date:[___DATEPARAM___%20TO%20*]&sort=last_load_date&dir=desc&pageSize=5&facets=basis_of_record',
  ...
  Query createRegionQuery(String layerId, String regionName){
    new Query([
      ...
      queryPath: '/ws/occurrences/search?q='+ layerId+':%22' + regionName.encodeAsURL() +'%22&fq=last_load_date:[___DATEPARAM___%20TO%20*]&sort=last_load_date&dir=desc&pageSize=5&facets=basis_of_record',
