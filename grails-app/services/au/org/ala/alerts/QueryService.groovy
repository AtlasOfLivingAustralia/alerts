...
class QueryService {
    ...
    Query createBioCacheAnnotationQuery(String biocacheWebserviceQueryPath, String biocacheUIQueryPath, String queryDisplayName, String baseUrlForWS, String baseUrlForUI, String resourceName) {
        ...
        new Query([
                ...
                queryPath     : biocacheWebserviceQueryPath + '&fq=(user_assertions:50005 OR user_assertions:50003 OR user_assertions:50002)&fq=last_assertion_date:' + '[___DATEPARAM___ TO *]'.encodeAsURL() + '&sort=+last_assertion_date&dir=desc&pageSize=20&facets=basis_of_record',
                queryPathForUI: biocacheUIQueryPath + '&fq=(user_assertions:50005 OR user_assertions:50003 OR user_assertions:50002)&fq=last_assertion_date:' + '[___DATEPARAM___ TO *]'.encodeAsURL() + '&sort=+last_assertion_date&dir=desc',
                dateFormat    : """yyyy-MM-dd'T'HH:mm:ss'Z'""",
                emailTemplate : '/email/biocache',
                recordJsonPath: '\$.occurrences',
                idJsonPath    : 'uuid',
