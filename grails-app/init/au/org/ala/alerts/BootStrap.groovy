    ...
    private void preloadQueries() {
        ...
        if(Query.findAllByName('Annotations').isEmpty()){
            Query newAssertions = (new Query([
                    ...
                    queryPath: '/ws/occurrences/search?fq=user_assertions:*&q=user_assertions:true AND last_assertion_date:[___DATEPARAM___%20TO%20*]&sort=last_assertion_date&dir=desc&pageSize=20&facets=basis_of_record',
