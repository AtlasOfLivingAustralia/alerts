  ...
  <g:form method="post">
    ...
    <div class="dialog">
      <table>
        ...
        <tr class="prop">
          <td valign="top" class="name">
            <label for="url"><g:message code="query.url.label" default="Url"/></label>
          </td>
          <td valign="top" class="value ${hasErrors(bean: queryInstance, field: 'url', 'errors')}">
            <g:textField name="url" value="${queryInstance?.url}"/>
          </td>
        </tr>
        ...
        <tr class="prop">
          ...
          <td valign="top" class="value ${hasErrors(bean: queryInstance, field: 'lastResult', 'errors')}">
            <g:textArea cols="30" rows="30" name="lastResult" value="${queryInstance?.lastResult}"/>
          </td>
        </tr>
