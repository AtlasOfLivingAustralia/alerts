...
<html>
  ...
  <body>
    ...
    <g:each in="${records}" var="dataset">
      <tbody>
      <tr>
        <td>${dataset.listName}</td>
         <td>
           <a href="${grailsApplication.config.collectory.baseURL}/public/show/${dataset.dataResourceUid}"><g:message code="datasets.view.details.of" args="[dataset.listName]" /></a>
         </td>
      </tr>
      </tbody>
    </g:each>
