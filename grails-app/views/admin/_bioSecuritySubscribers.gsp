<div name="subscribers" id="subscribers_${queryid}">
    ...
    <g:each in="${subscribers}" var="subscriber">
        ...
        <span class="badge badge-outline-primary">${subscriber.email} <i onclick="unsubscribe(${queryid}, ${subscriber.id},'${subscriber.email}')" class="fas fa-trash clickable"  ></i></span>
    </g:each>
