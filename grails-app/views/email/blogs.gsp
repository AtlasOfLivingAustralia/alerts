...
<html>
<head>
<title>Email alert from Atlas of Living Australia</title>
...
.yshortcuts, .yshortcuts a, .yshortcuts a:link, .yshortcuts a:visited, .yshortcuts a:hover, .yshortcuts a span {
    ...
    /* This most probably won't work in all email clients. Don't include <code _tmplitem="430" > blocks in email. */
code {
    white-space: normal;
                ...
                <tr>
                    <td id="header" class="w640" width="640" align="center" bgcolor="#3d464c" style="border-top:2px solid #c7c7c7;">
                        <div align="right" style="text-align: right;">
                            <a href="http://www.ala.org.au/" title="visit the ALA website"><img src="http://www.ala.org.au/wp-content/themes/ala2011/images/logo.png" alt="ALA logo" style="display: block; margin: 15px 25px;"></a>
                        </div>
                    </td>
                </tr>
