<div name="subscribers" id="subscribers_${queryid}">
    ...
    <g:each in="${subscribers}" var="subscriber">
        ...
        <span class="badge badge-primary-outline">${subscriber.email} <i onclick="unsubscribe(${queryid}, ${subscriber.id},'${subscriber.email}')" class="fas fa-trash clickable"  ></i></span>
    </g:each>
