  ...
  <body>
    ...
    <g:each in="${records}" var="dataset">
      ...
      <tr>
        <td>${dataset.label}</td>
         <td>
           <a href="${grailsApplication.config.collectory.baseURL}/public/show/${dataset.i18nCode.substring(dataset.i18nCode.indexOf('.') + 1)}"><g:message code="datasets.view.details.of" args="[dataset.label]" /></a>
         </td>
      </tr>
      </tbody>
    </g:each>
